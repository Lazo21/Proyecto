    ...
    <form action="" method="post" >
        <div class="card" >
            <div class="card-header" style= "background-color:#ABB2B9; border: 1px solid black;" >
                <center><h4>Paciente Mayor de Edad<svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
            ...
            <div class="mb-3">
                    ...
                    <input type="Number" class="form-control" name="expediente" id="expediente" aria-describedby="helpId" placeholder="">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" name="tel" id="tel" aria-describedby="helpId" placeholder="">
                </div>

                <div class="mb-3">
                    <label for="fechaNac" class="form-label">Fecha de nacimiento</label>
                    <input type="date" class="form-control" name="fechaNac" id="fechaNac" aria-describedby="helpId" placeholder="">
                </div>
                ...
                <div class="mb-3">
                    <label for="nombre" class="form-label">Profesión / Ocupación</label>
        ...
        <table class="table" id="tabla"  style="width: max-top;">       
            <thead class="table table-striped">
                <tr>
                    ...
                    <th scope="col" class="text-center"> Profesión/Ocupación </th>
