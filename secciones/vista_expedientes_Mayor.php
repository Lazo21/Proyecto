    ...
    <form action="" method="post">
        <div class="card">
            <div class="card-header" style= "background-color:#ABB2B9 ; border: 1px solid black;">
                <center><h4>Expediente mayor de Edad<svg xmlns="http://www.w3.org/2000/svg" width="40" height="25" fill="currentColor" class="bi bi-file-medical-fill" viewBox="0 0 16 16">
...
<div class="col-xxl-9">
<br><br><br><br>
<center><h2>Registros de expedientes mayores de edad</h2></center>
