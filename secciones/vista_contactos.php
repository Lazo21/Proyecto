    ...
    <form action="" method="post">
        <div class="card">
            ...
            <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nombre" id="nombre" aria-describedby="helpId" placeholder="Nombre Contacto">
                </div>

                <div class="mb-3">
                    <label for="" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="email" aria-describedby="helpId" placeholder="Email Contacto">
                    <label for="" class="form-label">Email Secundario</label>
                    <input type="email" class="form-control" name="email2" id="email2" aria-describedby="helpId" placeholder="Email Secundario">
                </div>

                <div class="mb-3">
                    <label for="" class="form-label">Teléfono</label>
                    <input type="number" class="form-control" name="telefono" id="telefono" aria-describedby="helpId" placeholder="Teléfono Contacto">
                </div>
                ...
                <div class="mb-3">
                    <label for="Email3" class="form-label">Email (Contacto de emergencia)</label>
                    <input type="email" class="form-control" name="Email3" id="Email3" aria-describedby="helpId" placeholder="Email Contacto Emergencia">
                </div>

                <div class="mb-3">
                    <label for="" class="form-label">Teléfono (Contacto de emergencia)</label>
                    <input type="number" class="form-control" name="telefono2" id="telefono2" aria-describedby="helpId" placeholder="Teléfono Contacto Emergencia">
                </div><br>

                

                <center><button type="submit" name="accion" value="guardar" class="btn btn-outline-success">GUARDAR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-save2-fill" viewBox="0 0 16 16">
                <path d="M8.5 1.5A1.5 1.5 0 0 1 10 0h4a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h6c-.314.418-.5.937-.5 1.5v6h-2a.5.5 0 0 0-.354.854l2.5 2.5a.5.5 0 0 0 .708 0l2.5-2.5A.5.5 0 0 0 10.5 7.5h-2v-6z"/>
                </svg></button>

                <button type="submit" name="accion" value="editar" class="btn btn-outline-primary">EDITAR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                </svg></button>

                <button type="submit" name="accion" value="eliminar" class="btn btn-outline-danger"> ELIMINAR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
        ...
        <table class="table" id="tabla" style="width:top";>       
            <thead class="table table-striped" ">
                <tr>
                    ...
                    <th scope="col" class="text-center"> Email Secundario</th>
            ...
            <?php foreach($listacontactos as $contacto) {?>  
                <tr>
                    ...
                    <td> <?php echo $contacto['Email2']; ?> </td>
                    <td> <?php echo $contacto['Telefono']; ?> </td>
                    <td> <?php echo $contacto['Nom_ce']; ?> </td>
                    <td> <?php echo $contacto['Email_ce']; ?> </td>     
                    <td> <?php echo $contacto['Tel_ce']; ?> </td>                
