    ...
    <form action="" method="post">
        <div class="card">
            <div class="card-header" style= "background-color:#ABB2B9; border: 1px solid black;">
                <center><h4>Expediente Menor de Edad<svg xmlns="http://www.w3.org/2000/svg" width="40" height="25" fill="currentColor" class="bi bi-file-medical-fill" viewBox="0 0 16 16">
            ...
            <label class="custom-control custom-radio"> Sexo <br>
             <div class="form-check">
                ...
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre de la madre, padre, persona responsable o representante legal</label>
                    <input type="text" class="form-control" name="edad" id="edad" aria-describedby="helpId" placeholder="">
                </div>

                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre de la escuela y grado académico</label>
                    <input type="text" class="form-control" name="escuela" id="escuela" aria-describedby="helpId" placeholder="Escuela">
                </div>
...
<div class="col-md-9">
<br><br><br><br>
<center><h2>Registros de expedientes menores de edad</h2></center>
        ...
        <table  class="table" id="tabla" style="width:top";>
            <thead class="table table-striped">
                <tr>
                    ...
                    <th scope="col" class="text-center"> Padres o Responsable </th>
