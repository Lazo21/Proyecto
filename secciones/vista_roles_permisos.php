...
<div class="col-md-3">
<br><br><br><br>
<center><h2>Control Roles y Permisos</h2></center>
    <form action="" method="post">
        <div class="card">
            <div class="card-header" style= "background-color:#ABB2B9 ; border: 1px solid black;">
                <center><h4>Roles y Permisos</h4></center>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="" class="form-label">Id Permiso</label>
                    <input type="number" class="form-control" name="id" id="id" aria-describedby="helpId" placeholder="" max="2" min="1">
                </div>
...
<div class="col-md-9">
<br><br><br><br>
<center><h2>Registros Roles y Permisos</h2></center>
    ...
    <div class="table-responsive">
        <table class="table" id="tabla" style="width: top;">       
            <thead class="table table-striped" ">
                <tr>
                    <th scope="col" class="text-center"> Nombre Rol </th>
                    <th scope="col" class="text-center"> Id Permiso </th>
            ...
            <tbody>
                <tr class="">
                    ...
                    <td>  </td>
                    <td>  </td>                    
                    <td> <button type="button" class="btn btn-outline-primary">Seleccionar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-index-thumb-fill" viewBox="0 0 16 16">
